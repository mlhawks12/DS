...
public:
	...
	//Modfiers
	void updateSongGroupPointer(SongGroupNode* ptr);//XXXXX
...
private:
  ...
  bool used; //True if the song is in a playlist, false otherwise vale (0,1)
...
GroupListNode* GroupExists(GroupListNode* song_groups, GroupID id);//XXXX
void MakeGroup(GroupListNode*& song_groups, GroupID id);//XXXXXX
bool SongInGroup(SongGroupNode* group_head, const Song& song);//XXXXXX
void AddToGroup(LibraryNode* library_ptr, GroupListNode* list_ptr);//XXXX
void RemoveFromGroup(LibraryNode* library_ptr, GroupListNode* song_groups);//XXX
void CombineGroups(GroupListNode*& song_groups, GroupListNode*& list_ptr1, GroupListNode*& list_ptr2);//XXX
void RemoveGroup(GroupListNode*& song_groups, GroupListNode* list_ptr);//XXXXX
void RecomputePrevByYear(GroupListNode* list_ptr);//XXXX


//Printing
void PrintLibrary(LibraryNode* library_head,std::ostream& print_file);//XXXX
void PrintGroupSequential(SongGroupNode* group_head,std::ostream& print_file);//XXXX
void PrintGroupRewind(SongGroupNode* group_ptr,std::ostream& print_file);  //Need a starting songXXXXXX
void PrintGroupMarathon(SongGroupNode* group_ptr,std::ostream& print_file); //Need a starting songXXXX
void PrintLongestGroupRewind(GroupListNode* group_head,std::ostream& print_file);//XXXXXXX

//Delete
void DeleteAllSongGroups(GroupListNode*& song_groups);//XXXXXXX
#endif
